...
type NestBookProps = {
  laravelbooks: ApiResponse;
};

const LaravelBooks = ({ laravelbooks }: NestBookProps) => {
  const [sortedBooks, setSortedBooks] = useState(laravelbooks.data);
